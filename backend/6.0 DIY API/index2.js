...
app.get("/jokes/:id", (req, res) => {
    ...
    if (!joke) {
        res.status(404).send("The joke with the given ID was not found.");
        return;
    } else {
        res.json(joke);
    }
...
//3. Get Joke Type
app.get("/filter/:jokeType", (req, res) => {
...
app.post("/jokes", (req, res) => {
    const joke = {
        id: jokes.length + 1,
        jokeText: req.query.jokeText,
        jokeType: req.query.jokeType,
    };
    jokes.push(joke);
    res.json(joke);
});
...
app.patch("/jokes/:id", (req, res) => {
    ...
    const updatedJoke = jokes[jokeIndex]
    if (!jokeIndex) {
        res.status(404).send("The joke with the given ID was not found.");
        return;
    } else {
        if (req.query.jokeText) {
            updatedJoke.jokeText = req.query.jokeText;
        }
        if (req.query.jokeType) {
            updatedJoke.jokeType = req.query.jokeType;
        }
        jokes.splice(jokeIndex, 1, updatedJoke);
...
app.delete("/all", (req, res) => {
    ...
    res.status(200).send("All jokes have been deleted.");
});
